				...
				<section id="banner">
					<div class="content">
						...
						<%
							...
							List<Subject> subjectList = subjectDAO.getTotalSubject();
							
						
							for (Subject subject : subjectList){
							%>
							<tr><td><button type="button" onclick="getSyllabusForm(event);">조회</button></td><td><%=subject.getAcademic_num()%></td><td><%=subject.getSubject_name() %></td><td><%=subject.getGrade() %></td><td><%=subject.getDepartment() %></td><td><%=subject.getYear_and_semester() %></td></tr>
							<%
							}
						%>
						...
						<form id="tempForSyllabus" action="SyllabusGetSelected.jsp" style="display:none;" method="post">
							<input type="text" name="subject_name" />
							<input type="text" name="academic_num" />
						</form>
