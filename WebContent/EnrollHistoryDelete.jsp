	...
	<div id="wrapper">
		...
		<div id="main">
			<div class="inner">
				...
				<!-- Header -->
				<header id="header">
					<a href="index.html" class="logo"><strong>수강신청 취소</strong></a>
					<ul class="icons">			
...
%>
			<tr>
				<td><button type="button" onclick="delete_list(this.id)" class="btn" id="<%=subject.getAcademic_num()%>">수강 신청 취소</button></td>
...
<!-- Sidebar -->
	...
	function delete_list(id){
		...
		select.parentNode.parentNode.parentNode.removeChild(select.parentNode.parentNode);	 // 테이블에서 삭제
		
		    	$.ajax({
		    		// ajax를 통한 백그라운드 연산.
		    		type : 'post',
		    		url : 'ajaxEnrollDelete.jsp',
		    		data : {
