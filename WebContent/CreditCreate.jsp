   ...
   <div id="wrapper">
      ...
      <div id="main">
         <div class="inner">
            ...
            <!-- Header -->
            <header id="header">
               <a href="index.html" class="logo"><strong>학점 등록</strong></a>
               <ul class="icons">         
...
<%             }else{ %> 
         <tr>
            ...
            <td><%=s.getDivision()%></td>
            <td>
            <input type = "text" style="width:100px; display:inline-block;" id="<%=stu+s.getAcademic_num()%>">
            <button type="button" onclick="enroll_credit(this.id,<%=stu%>,<%=s.getAcademic_num()%>)" class="displayinline btn small" id="<%=stu+s.getAcademic_num()%>">저장</button>
            </td>
         </tr>
...
<!-- Sidebar -->
   ...
   <!-- Scripts -->
   <script>
   function enroll_credit(id,student_num,academic_num){
      ...
      $.ajax({
          ...
          success : function(data) {
             ...
             if ($.trim(data) == 'false') {
                ...
                alert("학점이 저장되었습니다."); // 입력창과 버튼 제거 후 저장된 값 출력
                var temp = document.getElementById(id);
                temp.parentNode.textContent = credit_value;
             }
          }
       });
   }
