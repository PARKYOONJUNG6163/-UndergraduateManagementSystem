	...
	<div id="wrapper">
		...
		<div id="main">
			<div class="inner">
				...
				<!-- Header -->
				<header id="header">
					<a href="index.html" class="logo"><strong>학점 삭제</strong></a>
					<ul class="icons">			
...
%>
		 <tr>
            ...
            <button type="button" onclick="delete_credit(this.id,<%=stu%>,<%=s.getAcademic_num()%>)" class="displayinline btn small" id="<%=stu+s.getAcademic_num()%>">삭제</button>
            </td>
  	 	 </tr>
...
<!-- Sidebar -->
	...
	<!-- Scripts -->
	<script>
	function delete_credit(id,student_num,academic_num){
		var credit_value = document.getElementById(id).value;	
		
		$.ajax({
    		// ajax를 통한 백그라운드 연산.
    		type : 'post',
    		url : 'ajaxCreditDelete.jsp',
    		data : {
    		...
    		success : function(data) {
    			...
    			if ($.trim(data) == 'false') {
    				...
    				alert("학점이 삭제되었습니다."); // 입력창과 버튼 제거 후 저장된 값 출력
