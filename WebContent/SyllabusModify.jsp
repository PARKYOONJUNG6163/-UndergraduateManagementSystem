				...
				<section id="banner">
					<div class="content">
						...
						<%
							...
							%>
							<tr><td><button type="button" onclick="modifySyllabusForm(event);">수정</button></td><td><%=subject.getAcademic_num()%></td><td><%=subject.getSubject_name() %></td><td><%=subject.getGrade() %></td><td><%=subject.getDepartment() %></td><td><%=subject.getYear_and_semester() %></td></tr>
							<%
							}
						%>
					...
					<form id="tempForSyllabus" action="SyllabusModifyForm.jsp" style="display:none;" method="post">
